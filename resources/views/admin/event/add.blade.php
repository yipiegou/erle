...
@include('vendor.ueditor.assets')
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" id="exampleInputFile" name="signup_start">
        </div>
        <div class="form-group">
            <label for="exampleInputFile2">报名截止时间</label>
            <input type="date" id="exampleInputFile2" name="signup_end">
        </div>
        <div class="form-group">
            <label for="exampleInputFile2">开奖时间</label>
            <input type="date" id="exampleInputFile2" name="prize_date">
        </div>
        <div class="form-group">
            <label for="exampleInputFile2">报名人数限制</label>
            <input type="text" id="exampleInputFile2" onkeyup="value=value.replace(/[^\d]/g,'')" name="signup_num" placeholder="只能输入数字">
        </div>
